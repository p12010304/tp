...
*  The output logging level can be controlled using the `logLevel` setting in the configuration file (See the [Configuration guide](/tp/developer-guide/configuration.html) section).
