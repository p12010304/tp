...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            String failure = argMultimap.getPreamble().trim().isEmpty()
                    ? Messages.MESSAGE_MISSING_INDEX
                    : pe.getMessage();
            throw new ParseException(Messages.getCommandErrorWithUsage(failure, EditCommand.MESSAGE_USAGE), pe);
        }
