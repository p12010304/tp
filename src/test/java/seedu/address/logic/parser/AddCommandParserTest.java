...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                new AddCommand(expectedContactWithLastContacted));
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        // multiple last contacted values
        ...
        assertParseFailure(parser, INVALID_LAST_CONTACTED_DESC + validExpectedContactString,
                seedu.address.model.contact.LastContacted.MESSAGE_CONSTRAINTS);
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        // missing phone and zero tags
        Contact expectedPhoneContact = new ContactBuilder(BOB).withTags().withPhone(null).build();
        assertParseSuccess(parser, NAME_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                new AddCommand(expectedPhoneContact));

        // missing email and zero tags
        Contact expectedEmailContact = new ContactBuilder(BOB).withTags().withEmail(null).build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB,
                new AddCommand(expectedEmailContact));

        // missing address and zero tags
        Contact expectedAddressContact = new ContactBuilder(BOB).withTags().withAddress(null).build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB,
                new AddCommand(expectedAddressContact));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + VALID_PHONE_BOB + ADDRESS_DESC_BOB, expectedMessage);
