...
public class CommandTestUtil {
    ...
    public static final String VALID_LAST_CONTACTED_AMY = "22/02/26";
    public static final String VALID_LAST_CONTACTED_BOB = "23/02/26";
    ...
    public static final String INVALID_LAST_CONTACTED_DESC = " " + PREFIX_LAST_CONTACTED; // empty value not allowed
